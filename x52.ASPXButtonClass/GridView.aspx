<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="GridView.aspx.cs" Inherits="x52.ASPXButtonClass.GridViewModule" Title="GridView" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="GridViewDataSource" runat="server" DataObjectTypeName=" x52.ASPXButtonClass.Model.Issue"
        TypeName=" x52.ASPXButtonClass.Model.DataProvider"
        SelectMethod="GetIssues" InsertMethod="AddNewIssue" UpdateMethod="UpdateIssue"></asp:ObjectDataSource>

    <asp:ObjectDataSource ID="ContactsDataSource" runat="server" DataObjectTypeName=" x52.ASPXButtonClass.Model.Contact"
        TypeName=" x52.ASPXButtonClass.Model.DataProvider"
